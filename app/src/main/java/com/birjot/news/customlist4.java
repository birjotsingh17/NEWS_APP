...
import static com.birjot.news.R.drawable.india;

public class customlist4 extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    void initlist() {
        listView = (ListView) findViewById(R.id.custom_list4);


        countryobject co4 = new countryobject(cs, "CALGURY SUN");
        countryobject co5 = new countryobject(dc, "DAILY COURIER");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customlist4);
        initlist();
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(customlist4.this,web.class);

        switch (position){

            case 0:

                String at = "http://www.calgarysun.com/news";
            ...
            case 1:
                ...
                String au = "http://www.kelownadailycourier.ca/news/";
